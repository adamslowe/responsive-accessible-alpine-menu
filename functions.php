...
if ( ! function_exists( 'pgmenu_enqueue_scripts' ) ) :
    ...
    wp_register_script( 'inline-script-1', '', [], '0.0.7', false );
    ...
    wp_enqueue_script( 'pgmenu-pgia', get_template_directory_uri() . '/pgia/lib/pgia.js', [], '0.0.7', true);
    ...
    wp_enqueue_style( 'pgmenu-style', get_template_directory_uri() . '/css/style.css', [], '0.0.7', 'all');

    wp_deregister_style( 'pgmenu-style-1' );
    wp_enqueue_style( 'pgmenu-style-1', get_bloginfo('stylesheet_url'), [], '0.0.7', 'all');
